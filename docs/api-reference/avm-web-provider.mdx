...
| Name    | Type                                                         | Required | Default | Description                                                       |
|---------|--------------------------------------------------------------|----------|---------|-------------------------------------------------------------------|
| listener | (`params`?: [`IDiscoverParams`](types#idiscoverparams)) => [`IDiscoverResult`](types#idiscoverresult) \| `null`  | yes       | -       | The listener to call when the request message is sent, or null to remove the listener.                    |
