...
| Name     | Type                                                                                                                                                                                                                     | Required | Default | Description                                                                            |
|----------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------|---------|----------------------------------------------------------------------------------------|
| listener | (`params`?: [`ISignTransactionsParams`](types#isigntransactionsparams)) => ([`ISignTransactionsResult`](types#isigntransactionsresult) \| [`Promise<ISignTransactionsResult>`](types#isigntransactionsresult)) \| `null` | yes      | -       | The listener to call when the request message is sent, or null to remove the listener. |
