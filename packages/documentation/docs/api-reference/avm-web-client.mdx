...
| Name   | Type                                                   | Required | Default | Description                                                              |
|--------|--------------------------------------------------------|----------|---------|--------------------------------------------------------------------------|
| params | [`IAuthenticationParams`](types#iauthenticationparams) | yes      | -       | Params that specify which provider, signer and the data to authenticate. |
...
| Name   | Type                                     | Required | Default | Description                                                             |
|--------|------------------------------------------|----------|---------|-------------------------------------------------------------------------|
| params | [`IDisableParams`](types#idisableparams) | yes      | -       | Params that specify which provider,network and/or specific session IDs. |
...
| Name     | Type                                                                                                 | Required | Default | Description                                                                                                                   |
|----------|------------------------------------------------------------------------------------------------------|----------|---------|-------------------------------------------------------------------------------------------------------------------------------|
| callback | (`options`: [`IClientCallbackOptions`](types#iclientcallbackoptions)) => (`void` \| `Promise<void>`) | yes      | -       | The callback is called when a response message is received. If the result was successful, the `error` parameter will be null. |
...
| Name     | Type                                                                                                                 | Required | Default | Description                                                                                                                   |
|----------|----------------------------------------------------------------------------------------------------------------------|----------|---------|-------------------------------------------------------------------------------------------------------------------------------|
| callback | (`options`: [`IClientDiscoverCallbackOptions`](types#iclientdiscovercallbackoptions)) => (`void` \| `Promise<void>`) | yes      | -       | The callback is called when a response message is received. If the result was successful, the `error` parameter will be null. |
