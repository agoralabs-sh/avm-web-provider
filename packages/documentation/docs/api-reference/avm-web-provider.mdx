...
| Name     | Type                                                                                                                                                                                                                  | Required | Default | Description                                            |
|----------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------|---------|--------------------------------------------------------|
| callback | (`options`: [`IAVMWebProviderCallbackOptions`](types#iavmwebproviderlcallbackoptions)) => ([`IAuthenticationResult`](types#iauthenticationresult) \| [`Promise<IAuthenticationResult>`](types#iauthenticationresult)) | yes      | -       | The listener to call when the request message is sent. |
