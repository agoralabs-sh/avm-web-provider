...
If any providers do not support the `enable`  method, then a [`ARC0027MethodNotSupportedError`](../../api-reference/errors#arc0027methodnotsupportederror) will be returned.
