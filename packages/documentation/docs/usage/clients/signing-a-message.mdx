...
If this method is not supported, then a [`VIP030027MethodNotSupportedError`](/api-reference/errors#vip030027methodnotsupportederror) will be sent in the `error` parameter.

:::

:::caution

If the signer is not known, or not authorized, then a [`VIP030027UnauthorizedSignerError`](/api-reference/errors#vip030027unauthorizedsignererror) will be sent in the `error` parameter.
