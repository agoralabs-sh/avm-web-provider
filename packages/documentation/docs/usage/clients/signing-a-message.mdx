...
If this method is not supported, then a [`ARC0027MethodNotSupportedError`](../../api-reference/errors#arc0027methodnotsupportederror) will be sent in the `error` parameter.

:::

:::caution

If the signer is not known, or not authorized, then a [`ARC0027UnauthorizedSignerError`](../../api-reference/errors#arc0027unauthorizedsignererror) will be sent in the `error` parameter.
