...
If there is a group of atomic transactions, but the computed group ID is invalid, then a [`VIP030027InvalidGroupIdError`](/api-reference/errors#vip030027invalidgroupiderror) **SHOULD** be thrown.
