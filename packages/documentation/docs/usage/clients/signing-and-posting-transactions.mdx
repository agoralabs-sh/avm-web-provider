...
If there is a group of atomic transactions, but the computed group ID is invalid, then a [`VIP030027InvalidGroupIdError`](/api-reference/errors#vip030027invalidgroupiderror) **SHOULD** be returned.

:::

:::caution

If any of the transactions are malformed, then a [`VIP030027InvalidInputError`](/api-reference/errors#vip030027invalidinputerror) **SHOULD** be returned.
