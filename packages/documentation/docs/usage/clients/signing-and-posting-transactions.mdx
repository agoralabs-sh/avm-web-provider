...
If there is a group of atomic transactions, but the computed group ID is invalid, then a [`ARC0027InvalidGroupIdError`](../../api-reference/errors#arc0027invalidgroupiderror) should be thrown.
