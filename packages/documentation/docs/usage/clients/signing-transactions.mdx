...
The provider may attempt to compute ID of these atomic transactions and if it doesn't match the assigned ID, then a [`ARC0027InvalidGroupIdError`](../../api-reference/errors#arc0027invalidgroupiderror) may be thrown.
...
The provider may not support multisig accounts, in which case a [`ARC0027MethodNotSupportedError`](../../api-reference/errors#arc0027methodnotsupportederror) should be thrown.
...
If any of the accounts supplied in the `signers` list are not an authorized signer, then a [`ARC0027UnauthorizedSignerError`](../../api-reference/errors#arc0027unauthorizedsignererror) should be thrown.
...
The provider may not support re-keyed accounts, in which case a [`ARC0027MethodNotSupportedError`](../../api-reference/errors#arc0027methodnotsupportederror) will be thrown.
...
If the supplied `authAddr` is not an authorized signer, then a [`ARC0027UnauthorizedSignerError`](../../api-reference/errors#arc0027unauthorizedsignererror) will be thrown.
