...
The provider may attempt to compute ID of these atomic transactions and if it doesn't match the assigned ID, then a [`VIP030027InvalidGroupIdError`](/api-reference/errors#vip030027invalidgroupiderror) may be thrown.
...
The provider may not support multisig accounts, in which case a [`VIP030027MethodNotSupportedError`](/api-reference/errors#vip030027methodnotsupportederror) **SHOULD** be thrown.
...
If any of the accounts supplied in the `signers` list are not an authorized signer, then a [`VIP030027UnauthorizedSignerError`](/api-reference/errors#vip030027unauthorizedsignererror) **SHOULD** be thrown.
...
The provider may not support re-keyed accounts, in which case a [`VIP030027MethodNotSupportedError`](/api-reference/errors#vip030027methodnotsupportederror) will be thrown.
...
If the supplied `authAddr` is not an authorized signer, then a [`VIP030027UnauthorizedSignerError`](/api-reference/errors#vip030027unauthorizedsignererror) will be thrown.
