...
If the network is specified, and the provider does not support the network, then a [`ARC0027NetworkNotSupportedError`](../../api-reference/errors#arc0027networknotsupportederror) should be thrown.
