...
If the signer, supplied in the `params`, is not known, or not authorized, a [`ARC0027UnauthorizedSignerError`](../../api-reference/errors#arc0027unauthorizedsignererror) should be thrown.
