...
| Name   | Type                                                                                                                                                                                                                                          | Required | Default | Description                                                                                                                                |
|--------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------|---------|--------------------------------------------------------------------------------------------------------------------------------------------|
| error  | [`IBaseError`](#ibaseerror) \| `null`                                                                                                                                                                                                         | yes      | -       | If an error occured (defined as one of the [errors](./errors.md)), this will be defined. If a request was successful, this will be `null`. |
...
| Name       | Type     | Required | Default | Description                                                                             |
|------------|----------|----------|---------|-----------------------------------------------------------------------------------------|
| code       | `number` | yes      | -       | The code of the error. See the [error codes](./errors.md#summary) for more information. |
...
This is the basic type for an error. For specific details on errors check out the [errors](./errors.md).
