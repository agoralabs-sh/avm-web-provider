...
If this method is not supported, then a [`MethodNotSupportedError`](../api-reference/errors.md#methodnotsupportederror) should be thrown.
...
The provider may attempt to compute ID of these atomic transactions and if it doesn't match the assigned ID, then a [`InvalidGroupIdError`](../api-reference/errors.md#invalidgroupiderror) may be thrown.
...
The provider may not support multisig accounts, in which case a [`MethodNotSupportedError`](../api-reference/errors.md#methodnotsupportederror) should be thrown.
...
If any of the accounts supplied in the `signers` list are not an authorized signer, then a [`UnauthorizedSignerError`](../api-reference/errors.md#unauthorizedsignererror) should be thrown.
...
The provider may not support re-keyed accounts, in which case a [`MethodNotSupportedError`](../api-reference/errors.md#methodnotsupportederror) will be thrown.
...
If the supplied `authAddr` is not an authorized signer, then a [`UnauthorizedSignerError`](../api-reference/errors.md#unauthorizedsignererror) will be thrown.
