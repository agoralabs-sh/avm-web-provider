...
If there is a group of atomic transactions, but the computed group ID is invalid, then a [`InvalidGroupIdError`](../../api-reference/errors.md#invalidgroupiderror) should be thrown.

:::

:::caution

If any of the transactions are malformed, then a [`InvalidInputError`](../../api-reference/errors.md#invalidinputerror) should be thrown.

:::

:::caution

If the transactions fail to be accepted by the network, then a [`FailedToPostSomeTransactionsError`](../../api-reference/errors.md#failedtopostsometransactionserror) should be thrown.
