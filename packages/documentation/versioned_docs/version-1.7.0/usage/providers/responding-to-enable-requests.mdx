...
If the network is specified, and the provider does not support the network, then a [`NetworkNotSupportedError`](../../api-reference/errors.md#networknotsupportederror) should be thrown.
