...
If there is a group of atomic transactions, but the computed group ID doesn't match the assigned ID, then a [`InvalidGroupIdError`](../../api-reference/errors.md#invalidgroupiderror) should be thrown.
