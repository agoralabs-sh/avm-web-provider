...
If the signer, supplied in the `params`, is not known, or not authorized, a [`UnauthorizedSignerError`](../../api-reference/errors.md#unauthorizedsignererror) should be thrown.
