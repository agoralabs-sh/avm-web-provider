 ...
 * @property {MultisigMetadata} msig - [optional] Extra metadata needed when sending multisig transactions.
 * See {@link https://algorand.github.io/js-algorand-sdk/interfaces/MultisigMetadata.html algosdk.MultisigMetadata}.
 * @property {string[]} signers - [optional] A list of addresses to sign with (defaults to the sender in the
 * transaction).
...
export default IARC0001Transaction;
